  ...
  return (
    <div style={toolbarContainer}>
      <div style={toolbarGroup}>
        ...
        <button
          style={{
            ...iconButton,
            position: 'relative',
            background: historyPanelOpen ? 'rgba(76, 175, 80, 0.1)' : 'transparent',
          }}
          onClick={onHistory}
        ...
        <button
          style={{ ...iconButton, opacity: canUndo ? 1 : 0.3 }}
          onClick={onUndo}
          disabled={!canUndo}
        ...
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
            <path
              d="M3 7v6h6M21 17a9 9 0 00-9-9 9 9 0 00-9 9"
              stroke="currentColor"
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        <button
          style={{ ...iconButton, opacity: canRedo ? 1 : 0.3 }}
          onClick={onRedo}
          disabled={!canRedo}
        ...
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
            <path
              d="M21 7v6h-6M3 17a9 9 0 019-9 9 9 0 019 9"
              stroke="currentColor"
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
      ...
      <div style={toolbarGroup}>
        ...
        <button style={{ ...iconButton, position: 'relative' }} onClick={onFilter} title="Фильтр">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
            <path
        ...
        <button
          style={{
            ...iconButton,
            background: searchPanelOpen ? 'rgba(33, 150, 243, 0.1)' : 'transparent',
          }}
          onClick={onSearch}
          title="Поиск (Ctrl+F)"
        >
        ...
        <button
          style={{
            ...iconButton,
            background: analyticsOpen ? 'rgba(76, 175, 80, 0.1)' : 'transparent',
          }}
          onClick={onAnalytics}
          title="Аналитика"
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
            <path
              d="M4 19V10m6 9V5m6 14v-7m6 7V8"
              stroke="currentColor"
              strokeWidth="2"
              strokeLinecap="round"
            />
