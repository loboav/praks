 ...
 */
const ExpandedGroupNode = memo(({ data, selected }: NodeProps<Node<ExpandedGroupData>>) => {
    const label = data.label || 'Группа';
    const count = data.count || 0;

    return (
        <>
            <NodeResizer minWidth={200} minHeight={200} isVisible={selected} color="#ff0071" handleStyle={{ width: 10, height: 10, borderRadius: 3 }} />
            <div
                style={{
                    width: '100%',
                    height: '100%',
