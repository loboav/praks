...
namespace GraphVisualizationApp.Models
{
    public class ObjectType
    {
        ...
        public ICollection<PropertySchema> PropertySchemas { get; set; } = new List<PropertySchema>();
    }
    ...
    /// <summary>
    /// Схема свойств — определяет предзаданные поля для типа объекта или типа связи.
    /// Типы: string, number, date, boolean, enum
    /// </summary>
    public class PropertySchema
    {
        ...
        public string Key { get; set; } = string.Empty;        // "weight", "date", "Сумма"
        public string PropertyType { get; set; } = "string";   // string | number | date | boolean | enum
        public bool Required { get; set; }
        public string? DefaultValue { get; set; }
        public string? Options { get; set; }                    // JSON массив для enum: ["Да","Нет"]
    }
}
